...
// import { SessionUser } from '@/types/auth'; // SessionUser 型を削除
import type { User } from '@supabase/supabase-js'; // Supabase の User 型をインポート
...
export const POST = withAuthAndErrorHandling(
    // context の型を修正: { params: { id: string }, user: SessionUser } -> { params: Record<string, string>, user: User }
